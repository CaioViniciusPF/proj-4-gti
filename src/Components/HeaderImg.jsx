...
function HeaderImg({typeHeader}) {
 ...
 {fundoSobre}
  const sobHeader=(
    <section 
      className={`flex flex-col text-blue-gray-50  items-center px-[15%] pt-[76px] pb-5 bg-[url('${fundoSobre}')] bg-cover bg-no-repeat bg-center`} >
  ...
  const contHeader=(
  <section 
    className={`text-blue-gray-900 flex justify-center items-center px-[15%] pt-[76px] pb-5  md:bg-none bg-[#4E84A6] bg-[url('${contato}')] bg-contain bg-no-repeat bg-bottom`}>
